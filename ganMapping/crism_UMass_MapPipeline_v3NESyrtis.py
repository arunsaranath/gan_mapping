...
if __name__ == "__main__":
    ...
    srcFolder = "/Volume1/data/CRISM/yuki/v3_NESyrtis/"
    trgtFolder = "/Volume2/data/CRISM/AMS/v3_NESyrtis/"
    sLvl = 0.1
    scaleFlag = True
    ...
    '------------------------------------------------------------------------------------------------------------------'
    sliName = '/Volume1/data/CRISM/arun/neSyrtisSli_03_04_2021/UMass_exemplars_16A73_v1.sli'
    sliHdrName = '/Volume1/data/CRISM/arun/neSyrtisSli_03_04_2021/UMass_exemplars_16A73_v1.sli.hdr'
    ...
    'Reshape to shape of input size'
    mica_dataRed_Scale = mica_dataRed_Scale.reshape(mica_dataRed.shape[0], mica_dataRed.shape[1], 1)
        ...
        for file in f:
            if file.find('_nr_ds.img') != -1:
                ...
                for kernelSize in range(1,6,2):
                    ...
                    '--------------------------------------------------------------------------------------------------'
                    simScoreMapName = minMapTools(4, 240, imgType=file[:3]).create_Maps4CRISMImages_Cosine(
                        disRep,
                        mica_dataRed_Scale,
                        crSmoothImageName,
                        endMem_Name,
