...
if __name__ == "__main__":
    ...
    srcFolder = "/Volume1/data/CRISM/yuki/v3_IusChasma/"
    trgtFolder = "/Volume2/data/CRISM/AMS/v3_IusChasma/"
    sLvl = 0.1
    scaleFlag = True
    ...
    '------------------------------------------------------------------------------------------------------'
    sliName = '/Volume1/data/CRISM/arun/IusChasmaSli_05_21_2020/micaExem_wManual_IusChasma.sli'
    sliHdrName = '/Volume1/data/CRISM/arun/IusChasmaSli_05_21_2020/micaExem_wManual_IusChasma.hdr'
        ...
        for file in f:
            if file.find('_nr_ds.img') != -1:
                ...
                colMat = [[255, 0, 0], [255, 0, 0], [0, 255, 0], [0, 255, 0], [218, 165, 32], [189, 183, 107],
                          ...
                          [0, 206, 203], [192, 192, 192], [255, 165, 0], [255, 20, 147], [255, 105, 180], [210, 105, 30]
                          , [205, 133, 63], [255, 192, 203], [218, 112, 214]]
                colMat = np.asarray(colMat, dtype=np.float32)

                'Initialize the low confidence bands for which we are using higher thresholds'
                lowConfBands = [0, 7, 8, 20, 25, 26]
