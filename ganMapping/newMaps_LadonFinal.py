...
if __name__ == "__main__":
    ...
    srcFolder =  "/Volume2/data/CRISM/AMS/v3_ladon/FRT00013728"

    'Set the threshold levels for the various classes'
    threshMatrix = [[0.9, 0.975], [0.8, 0.95], [0.9, 0.975], [0.8, 0.95], [0.75, 0.95], [0.75, 0.95], [0.8, 0.95],
                    [0.9, 0.975], [0.75, 0.95], [0.75, 0.95], [0.75, 0.95], [0.75, 0.95], [0.75, 0.95], [0.75, 0.95],
                    [0.75, 0.95], [0.75, 0.95], [0.75, 0.95], [0.75, 0.95], [0.9, 0.975], [0.9, 0.975], [0.85, 0.95],
                    [0.9, 0.975], [0.85, 0.975], [0.9, 0.975]]
    threshMatrix = np.asarray(threshMatrix)

    'Set the colors for the various classes'
    colMat= [[255, 0, 0], [255, 0, 0], [0, 255, 0], [0, 255, 0], [255, 69, 0], [255, 255, 0], [255, 0, 255],
             [255, 20, 147], [0, 0, 0], [139, 69, 19], [65, 105, 225], [0, 255, 255], [0, 255, 255], [0, 0, 0],
             [95, 158, 160], [250, 128, 114], [0, 0, 0], [0, 0, 0], [0, 206, 209], [0, 0, 0], [255, 165, 0],
             [128, 0, 128], [128, 128, 0], [192, 192, 192]]
