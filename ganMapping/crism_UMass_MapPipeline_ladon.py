...
if __name__ == "__main__":
    ...
    '------------------------------------------------------------------------------------------------------'
    sliName = '/Volume1/data/CRISM/arun/micaSli_2_17_2020/UMass_micaExemplars.sli'
    sliHdrName = '/Volume1/data/CRISM/arun/micaSli_2_17_2020/UMass_micaExemplars.sli.hdr'
