...
if __name__ == "__main__":
    ...
    srcFolder = "/Volume2/data/CRISM/AMS/sabcondv4/jezeroNew"
    trgtFolder = "/Volume2/data/CRISM/AMS/sabcondv4/jezeroNew"
    sLvl = 0.1
    scaleFlag = True
    ...
    '------------------------------------------------------------------------------------------------------------------'
    sliName = '/Volume1/data/CRISM/arun/UMass_redMICA_CR_enhanced_v5.sli'
    sliHdrName = '/Volume1/data/CRISM/arun/UMass_redMICA_CR_enhanced_v5.sli.hdr'
    ...
    for r, d, f in os.walk(srcFolder):
        for file in f:
            if file.find('_CRnR.img') != -1:
                'The image name is'
                crInterpImageName = os.path.join(r, file)
                ...
                for kernelSize in range(1, 6, 2):
                    ...
                    maskName = minMapTools(4, 240).create_Mask4CRISMImages(crSmoothImageName)
