...
if __name__ == "__main__":
    ...
    srcFolder = "/Volume1/data/CRISM/yuki/gale_rachel_ds/FRT0000C518/"
    trgtFolder = "/Volume2/data/CRISM/AMS/gale_rachel_ds/FRT0000C518/"
    sLvl = 0.1
    scaleFlag = True
    ...
    '------------------------------------------------------------------------------------------------------------------'
    sliName = '/Volume1/data/CRISM/arun/galeSli_07_27_2020/UMass_galeExemplars_v1.sli'
    sliHdrName = '/Volume1/data/CRISM/arun/galeSli_07_27_2020/UMass_galeExemplars_v1.hdr'
        ...
        for file in f:
            ...
            if file.find('_nr_ds.img') != -1:
                ...
                for kernelSize in range(1,6,2):
                    ...
                    maskName = minMapTools(4, 240, imgType=file[:3]).create_Mask4CRISMImages(crSmoothImageName, sigAbsoprtionLevel=0.994)
                    ...
                    bestGuessName = minMapTools(4, 240,
