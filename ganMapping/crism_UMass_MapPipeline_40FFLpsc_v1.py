...
if __name__ == "__main__":
    ...
    trgtFolder = "/Volume2/data/CRISM/AMS/v5_20200303/"
    sLvl = 0.1
    scaleFlag = True
    ...
    '------------------------------------------------------------------------------------------------------------------'
    sliName = '/Volume1/data/CRISM/arun/jezeroSli_2_3_2020/UMass_jezeroExemplars_fandango_v4.sli'
    sliHdrName = '/Volume1/data/CRISM/arun/jezeroSli_2_3_2020/UMass_jezeroExemplars_fandango_v4.sli.hdr'
