...
if __name__ == "__main__":
    ...
    srcFolder = "/Volume1/data/CRISM/arun/sabcondv3/gale/HRL0000BABA"
    trgtFolder = "/Volume2/data/CRISM/AMS/sabcondv3/gale_new/HRL0000BABA"
    sLvl = 0.1
    scaleFlag = True
        ...
        for file in f:
            if file.find('_nr.img') != -1:
                ...
                for kernelSize in range(1,6,2):
                    ...
                    maskName = minMapTools(4, 240, imgType=file[:3]).create_Mask4CRISMImages(crSmoothImageName, sigAbsoprtionLevel=0.988)