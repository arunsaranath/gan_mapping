...
if __name__ == "__main__":
    ...
    srcFolder = "/Volume1/data/CRISM/yuki/v3_melas_chasma/"
    trgtFolder = "/Volume2/data/CRISM/AMS/v3_melas_chasma/"
    sLvl = 0.1
    scaleFlag = True
    ...
    '------------------------------------------------------------------------------------------------------'
    sliName = '/Volume1/data/CRISM/arun/melasSli_02_19_2020/UMass_melasExemplars_v1.sli'
    sliHdrName = '/Volume1/data/CRISM/arun/melasSli_02_19_2020/UMass_melasExemplars_v1.sli.hdr'
        ...
        for file in f:
            if file.find('_nr_ds.img') != -1:
                ...
                for kernelSize in range(1,6,2):
                    ...
                    maskName = minMapTools(4, 240, imgType=file[:3]).create_Mask4CRISMImages(crSmoothImageName, sigAbsoprtionLevel=0.992)