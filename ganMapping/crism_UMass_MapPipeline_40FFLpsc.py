...
if __name__ == "__main__":
    ...
    srcFolder = "/Volume1/data/CRISM/yuki/v5_20200117/"
    trgtFolder = "/Volume2/data/CRISM/AMS/v6_20200227/"
    sLvl = 0.1
    scaleFlag = True
    ...
    '------------------------------------------------------------------------------------------------------------------'
    sliName = '/Volume1/data/CRISM/arun/jezeroSli_2_3_2020/UMass_jezeroExemplars_fandango_v3.sli'
    sliHdrName = '/Volume1/data/CRISM/arun/jezeroSli_2_3_2020/UMass_jezeroExemplars_fandango_v3.hdr'
    ...
    for r, d, f in os.walk(srcFolder):
        for file in f:
            ...
            if file.find('lam2_cbc11_40A2_tu2_nr_ds') != -1:
                'The image name is'
