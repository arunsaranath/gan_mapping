...
if __name__ == "__main__":
    ...
    '------------------------------------------------------------------------------------------------------------------'
    sliName = '/Volume1/data/CRISM/arun/jezeroSli_2_3_2020/UMass_jezeroExemplars_fandango_v4_final.sli'
    sliHdrName = '/Volume1/data/CRISM/arun/jezeroSli_2_3_2020/UMass_jezeroExemplars_fandango_v4_final.hdr'
