...
if __name__ == "__main__":
    ...
    srcFolder =  "/Volume2/data/CRISM/AMS/v5_final/"

    'Set the threshold levels for the various classes'
    threshMatrix = [[0.95, 0.975], [0.8, 0.95], [0.95, 0.97], [0.83, 0.88], [0.85, 0.95], [0.85, 0.95], [0.75, 0.95],
                    ...
                    [0.99, 0.995], [0.99, 0.995], [0.98, 0.99], [0.98, 0.99], [0.99, 0.995], [0.99, 0.995], [0.85, 0.95],
                    [0.9, 0.97], [0.9, 0.97], [0.9, 0.97], [0.85, 0.95]]
    ...
    colMat= [[255, 0, 0], [255, 0, 0], [0, 255, 0], [0, 255, 0], [218, 165, 32], [255, 255, 0], [255, 0, 255],
             ...
             , [128, 128, 0], [128, 128, 0],  [255, 215, 0], [255, 215, 0], [255, 215, 0], [255, 215, 0], [222, 110, 30],
             [255, 128, 0], [255, 128, 0], [255, 128, 0], [218, 165, 32]]
    colMat = np.asarray(colMat)
    imgName=''

    for r, d, f in os.walk(srcFolder):
        for file in f:
            if ((file.find('_smoothed3_CR_micaMaps_Cosine.img') != -1)):
                'The image name is'
    ...
    for r, d, f in os.walk(srcFolder):
        for file in f:
            if file.find('_smoothed3_CR_micaMaps_BestGuess_final.img') != -1:
