...
sliName = '/Volume1/data/CRISM/arun/oldSliFiles/CR_MICA_Spectrum_full_v6.sli'
sliHdrName = '/Volume1/data/CRISM/arun/oldSliFiles/CR_MICA_Spectrum_full_v6.sli.hdr'
...
for r,d,f in os.walk(micaBaseFolder):
    for file in f:
        ...
        if file.find('.lbl') != -1:
            ...
            f1 = interpolate.interp1d(micaSpectra[:, 0], micaSpectra[:, 3])
